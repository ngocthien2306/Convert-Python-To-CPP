...
namespace ortcv
{
	class LITE_EXPORTS SCRFD : public BasicOrtHandler
	{
        ...
        private:
            ...
            void distance2bbox(const SCRFDScaleParams& scale_params,
            ...
            void distance2kps(const SCRFDScaleParams& scale_params,
                Ort::Value& score_pred,
                Ort::Value& bbox_pred,
                Ort::Value& kps_pred,
                unsigned int stride,
        ...
        public:
            void detect(cv::Mat img, vector<types::BoxfWithLandmarks>& detected_boxes_kps, 
