// copy from https://github.com/DefTruth/lite.ai.toolkit/blob/main/lite/ort/core/ort_handler.h
...
namespace core
{
    ...
    protected:
        virtual std::vector<Ort::Value> preprocessing(const std::vector<cv::Mat>& mats) = 0;
